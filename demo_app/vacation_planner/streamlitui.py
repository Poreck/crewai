...
# --------------------------------------------------------
# Configuration de la page + Thème clair
# --------------------------------------------------------
# Note: some Streamlit versions don't accept a `theme` kwarg in set_page_config.
# We keep the page config here and apply visual theming via CSS below.
st.set_page_config(
    page_title="Personal AI Vacation Planner ",
    page_icon="✈️",
    layout="wide",
...
if submitted and destination:
    with st.spinner("🌍 Planning your amazing vacation... This may take a few minutes."):
        try:
            inputs = {"topic": destination, "current_year": str(datetime.now().year)}
